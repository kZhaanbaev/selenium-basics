...
public class _02_ClassTask_Solved_NEW {
    /**
    ...
    public static void main(String[] args) {
        ...
        driver.findElement(By.xpath("//ul[@class='main-navigation']/li/a[text()='WordPress Development']")).click();
        ...
        // Click "Front End Design" -> "Javascript" -> "Ajax" & Verify you see text "You have clicked -- Ajax -- button"
        driver.findElement(By.xpath("//a[text() = 'Front End Design']")).click();
        driver.findElement(By.xpath("//li/a[text() = 'JavaScript']")).click();
        driver.findElement(By.xpath("//a[text() = 'Ajax']")).click();
        System.out.println(driver.findElement(By.xpath("//a[text() ='Ajax']")).isDisplayed());
